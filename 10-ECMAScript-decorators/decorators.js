...
var Person = function () {
    ...
    var Person = _classThis = /** @class */ (function () {
        function Person_1() {
            this.name = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _name_initializers, "Dilnawaz"));
            __runInitializers(this, _name_extraInitializers);
        }
        //   constructor() {
        //     this.greet = this.greet.bind(this);
        //   }
        Person_1.prototype.greet = function (number) {
    ...
    (function () {
        ...
        _name_decorators = [replacer("New Name")];
